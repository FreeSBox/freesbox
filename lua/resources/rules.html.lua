	...
	<ol>
		<li>
			...
			<ol>
				...
				<li>
					Петиция игрока должна четко определить, чем является предложенный оружейный пак или оружие (Заменой или Аддоном к ядру). В противном случае петиция будет подлежать удалению.
				</li>
			</ol>
		</li>
	</ol>

	<h1>ПРАВИЛА ДЛЯ АДМИНОНВ</h1>
	<ol>
		<li>
