...
<body>
	...
	<ol>
		...
		<li>Запрещено использовать blider'ы. Наказание: В первый раз Jail на 350 секунд, во второй Ghostban на 2 часа, в третий раз Ghostban на 7 дней и дальше срок бана будет удваиваться.</li>
