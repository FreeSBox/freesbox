...
<body>
	...
	<ol>
		...
		<li>Запрещено толкать людей предметами.<br>Наказание <i>до</i> 10 минут <i>минимум</i> если вы были в build режиме во время нарушения, и минимум 15 минут если вы были в pvp режиме.</li>
	</ol>
	<h2>ОГРАНИЧЕНИЯ</h2>
	<ol>
		<li>
