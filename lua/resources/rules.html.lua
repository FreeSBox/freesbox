	...
	<ol>
		<li>
			...
			<small>
				...
				в который создатель в праве вносить изменения в заповеди.
				<br>
		...
		<li>Петиции не могут мешать игрокам пользоваться системой петиций.</li>
		...
		<li>Нельзя создовать петицию если такая же петиция доступна для голосования.</li>
	</ol>
