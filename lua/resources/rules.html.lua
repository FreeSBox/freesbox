...
<body>
	...
	<ol>
		...
		Исключением является использования их против нарушающих или мешающих игроков при отсутсвии админов.
		<br>
		...
		<li>Запрещена помеха РП и строительству, если вам сказали перестать.<br>Наказание от 4 минут jail, до пермача.</li>
	</ol>
</body>
<style>
	:root {
