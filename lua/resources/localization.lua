...
return {
	["en"] =
	{
		...
		["http_chat.too_long"] = "Your message is too long: %i/%i",
		...
		["scoreboard.copy_real_name"] = "Copy Steam Name",
	...
	["ru"] =
	{
		...
		["http_chat.too_long"] = "Ваше сообщение слишком длинное: %i/%i",
		...
		["scoreboard.copy_real_name"] = "Копировать ник из Steam",
